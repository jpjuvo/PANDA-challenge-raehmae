# modified from
# https://github.com/lessw2020/Ranger-Mish-ImageWoof-5/blob/master/mxresnet.py
...
def get_mxresnet_func(arch):
    n_layers = int(arch.replace('mxresnet',''))
    for n,e,l in [
        [ 18 , 1, [2,2,2 ,2] ],
        [ 34 , 1, [3,4,6 ,3] ],
        [ 50 , 4, [3,4,6 ,3] ],
        ...
        if n == n_layers:
            return partial(mxresnet, expansion=e,n_layers=l, name=f'mxresnet{n}')
    return None
