...
sz = 299 # image tile size
N = 25 #number of tiles per image

# These are tile data specific - check the correct values from preprocessing notebook
mean = torch.tensor([0.14192033, 0.29737725, 0.19652261])
std = torch.tensor([0.39635435, 0.52671275, 0.42666426])

######################################
############## PATHS #################

# Tile image folder path
TRAIN = '../../train_1_299_299_5x5-skeleton-mask/'
# Path to train.csv
LABELS = '../../../TRAIN/train.csv'

SAVE_DIR = '../models/panda-models-299-299_2'
...
model_n_out = 6 # This is 6 with classification and 5 with ordinal as it predicts only labels >= 1.
final_dropout = 0.85
is_ordinal = False
...
pretrained_dir = "./models/panda-models-299-299_1/" # own pre-trained dir
