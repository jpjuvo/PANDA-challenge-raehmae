...
N = 24 #number of tiles per image

# These are tile data specific - check the correct values from preprocessing notebook (inverse mean)
mean = torch.tensor([0.10437643, 0.21545999, 0.1428814])
std = torch.tensor([0.38000888, 0.51681375, 0.41820398])

######################################
############## PATHS #################

# Tile image folder path
TRAIN = '../../train_1_384_256_4x6-skeleton-mask/'
# Path to train.csv
LABELS = '../../../TRAIN/train.csv'

SAVE_DIR = '../models/panda-models-384-256-ordinal_1'
...
pretrained_dir = "./models/panda-models-384-256-ordinal_0/" # own pre-trained dir
